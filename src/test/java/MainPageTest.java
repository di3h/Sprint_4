...
public class MainPageTest {
    ...
    public MainPageTest(int questionId, String expectedAnswerText) {
    ...
    @Test
    public void isAnswerTextEqualsExpectedText() {
        driver = AppConfig.getBrowser();
        driver.get(AppConfig.MAIN_PAGE_URL);
        MainPage page = new MainPage(driver);
        ...
        String actualAnswerText = page.getFaqAnswerText();

        //проверяем, что текст ответа совпадает с ожидаемым текстом
        assertEquals("Фактический текст ответа не совпадает с ожидаемым", expectedAnswerText, actualAnswerText);
